 ...
 * This will save memory for over-creating new object again and again.
 * In this particular situation, juice will be consumed after been ordered, but it depends on the situation. Maybe
 * in other case object will not be consumed so it can be re-used rather than creating new.
 */
